<template>
  ...
  <div class="register-wrapper" :class="{'light-theme': !isDarkTheme}">
    ...
    <div class="main-container">
      <div class="register-card glass-effect">
        <div class="register-left">
          <h2 class="register-title gradient-text">注册阅界</h2>
          <form class="register-form">
            <div class="form-group">
              <input v-model="username" type="text" placeholder="请输入您的手机号码" class="input modern-input" />
            </div>
            <div class="form-group">
              <input v-model="password" type="password" placeholder="请输入密码：6-20位字母/数字" class="input modern-input" />
            </div>
            <div class="form-group code-group">
              <input v-model="velCode" type="text" maxlength="4" placeholder="请输入验证码" class="input modern-input code-input" />
              <img :src="imgVerifyCode" @click="loadImgVerifyCode" class="code-img" title="点击刷新验证码" />
            </div>
            <div class="form-group code-group">
              <input v-model="smsCode" type="text" maxlength="6" placeholder="请输入短信验证码" class="input modern-input code-input" />
              <input type="button" class="get-sms-btn" :disabled="smsSending" :value="smsSending ? countdown + 's 后重试' : '获取验证码'" @click="getSmsCode" />
            </div>
            <div class="form-group">
              <button type="button" class="register-btn gradient-btn" @click="registerUser">注册</button>
            </div>
          </form>
        </div>
        <div class="register-right">
          <div class="login-tip">已有账号？</div>
...
export default {
  ...
  setup() {
    ...
    const getSmsCode = async () => {
      ...
      try {
        await verifyImgCode({ sessionId: state.sessionId, code: state.velCode });
...
.register-wrapper.light-theme .register-card {
...
.register-wrapper:not(.light-theme) .input.modern-input {
  color: #fff;
...
.register-btn.gradient-btn:hover {
...
.register-wrapper.light-theme .register-right {
...
.register-wrapper.light-theme .login-tip {
  color: #1976d2;
}
.login-btn {
...
.register-wrapper.light-theme .login-btn {
  background: #fff;
  color: #1976d2;
  border: none;
}
...
.register-wrapper.light-theme .login-btn:hover {
  background: #e3f2fd;
  color: #1565c0;
  box-shadow: 0 4px 16px rgba(33,150,243,0.18);
}
